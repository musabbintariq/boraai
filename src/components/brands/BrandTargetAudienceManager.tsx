            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2 mt-2">
                {persona.pain_points.map((point, index) => (
                  <Badge key={index} variant="outline" className="bg-red-50 border-red-200 text-red-800">{point}</Badge>
                ))}
              </div>
            </div>
          )}
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2 mt-2">
                {persona.goals.map((goal, index) => (
                  <Badge key={index} variant="outline" className="bg-green-50 border-green-200 text-green-800">{goal}</Badge>
                ))}
              </div>
            </div>
          )}
